	...
	nodes: [
		{
			...
			host: process.env.lavaHost || "", //- The host name or IP of the lavalink server.
			port: parseInt(process.env.lavaPort) || 80, // The port that lavalink is listening to. This must be a number!
			password: process.env.lavaPass || "", //- The password of the lavalink server.
